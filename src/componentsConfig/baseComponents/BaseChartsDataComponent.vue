...
export default {
  ...
  setup(props) {
    ...
    const option = computed(() => currConfigItem.value.option);
  ...
  methods: {
    ...
    handleChange(value, coordsOption) {
      try {
        console.log('%cBaseChartsDataComponent.vue line:105 value', 'color: #007acc;', value);
