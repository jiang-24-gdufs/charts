    ...
    <base-collapse-style-component v-bind="$props">
        ...
        <smart-collapse-item>
            <div slot="title" style="display: flex;align-items: center;font-size: 13px;"  >
                ...
                <span @click.prevent.stop  style="margin-left: 10px;">
                       <el-switch v-model="title.show" size="mini"></el-switch>
                </span>
            </div>
            <!--图表标题配置项-->
        ...
        <smart-collapse-item>
            <div slot="title" style="display: flex;align-items: center;font-size: 13px;">
                ...
                <span>工具栏配置</span>
                <span @click.prevent.stop  style="margin-left: 10px;">
                    <el-switch v-model="toolbox.show" size="mini"></el-switch>
                </span>
            </div>
            <!--图表工具箱配置项-->
        ...
        <smart-collapse-item>
            <div slot="title" style="display: flex;align-items: center;font-size: 13px;">
                ...
                <span>提示框</span>
                <span @click.prevent.stop  style="margin-left: 10px;">
                    <el-switch v-model="tooltip.show" size="mini" ></el-switch>
                </span>
            </div>
            <!--提示框配置-->
        ...
        <smart-collapse-item>
            <div slot="title" style="display: flex;align-items: center;font-size: 13px;">
                ...
                <span>图例配置</span>
                <span @click.prevent.stop  style="margin-left: 10px;">
                    <el-switch v-model="legend.show" size="mini"></el-switch>
                </span>
            </div>
            <!--图例配置相比-->
        ...
        <smart-collapse-item :title="`绘图区(${item.name})`" icon="fa fa-paint-brush" :key="index"
            ...
            <series :series="item"  @switch-charts="({chartsType,series}) => {handleSwitchChartsType(chartsType,series,index)}"></series>
        </smart-collapse-item>
